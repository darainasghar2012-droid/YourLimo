export default function WhatsAppButton() {
  return (
    <a
      ...
      className="hidden lg:flex fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-[#25D366] items-center justify-center shadow-lg hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(37,211,102,0.5)] transition-all duration-300"
    >
